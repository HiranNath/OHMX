...
const StorePage: React.FC = () => {
  ...
  // Creates and opens the WhatsApp checkout link
    ...
    <div className="bg-black text-white pt-24 pb-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col sm:flex-row justify-between sm:items-center gap-8 mb-12">
          ...
          <button
            onClick={() => navigate('/')}
            className="hidden sm:inline-flex items-center px-6 py-3 bg-gray-800 text-white font-semibold rounded-full hover:bg-gray-700 transition-colors"
          >
        ...
        {cartItems.length > 0 && (
          <div className="bg-gray-900 p-6 rounded-2xl mb-12 ring-1 ring-orange-500/50">
              ...
              <div className="p-6 flex flex-col flex-grow">
                ...
                <div className="flex justify-between items-center mt-4">
                  ...
                  <button
                    ...
                    className="px-5 py-2 bg-orange-500 text-black font-semibold rounded-full hover:bg-orange-600 transition-colors"
                  >
                    Add to Cart
                  </button>
                </div>
